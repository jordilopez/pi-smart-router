...
describe("backward compatibility", () => {
  it("configs that omit cheapMax validate and get the 0.18 default at resolution time", async () => {
    ...
    // The resolver supplies 0.18 as the effective default (covered in
