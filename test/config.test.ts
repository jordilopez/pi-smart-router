...
describe("backward compatibility", () => {
  it("configs that omit cheapMax validate and get the 0 (rule-driven) default at resolution time", async () => {
    ...
    // The resolver supplies 0 as the effective default (covered in
